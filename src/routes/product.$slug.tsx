          ...
          <div className="md:sticky md:top-32 md:self-start">
            ...
            <div className="mt-8">
              <div className="flex items-center justify-between">
                ...
                <button className="text-[10px] uppercase tracking-[0.28em] underline">
                  Size guide
                </button>
              </div>
            ...
            <div className="mt-8 space-y-3 hairline pt-6 text-[11px] uppercase tracking-[0.24em] text-muted-foreground">
              ...
              <div className="flex items-center gap-3">
                <ShieldCheck className="h-4 w-4" strokeWidth={1.4} /> Lifetime alterations in every
                store
              </div>
            </div>
              ...
              {[
                {
                  ...
                  body: "Woven in a single European mill from GOTS-certified fibers. Mother-of-pearl buttons, French seams, and a soft-collar roll finished by hand.",
                },
                {
                  id: "care",
                  title: "Care",
                  body: "Cold hand wash or dry clean. Air dry flat, iron on low. Store folded to preserve shape.",
                },
                {
                  id: "shipping",
                ...
                <div key={row.id} className="border-b border-border">
                  <button
                    ...
                    className="flex w-full items-center justify-between py-4 text-left text-[11px] uppercase tracking-[0.28em]"
                  >
                    {row.title}
                    <ChevronDown
                      className={`h-4 w-4 transition-transform ${open === row.id ? "rotate-180" : ""}`}
                    />
                  </button>
                  {open === row.id && (
                    <motion.p
