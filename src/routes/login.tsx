...
export const Route = createFileRoute("/login")({
  head: () => ({ meta: [{ title: "Sign in — HASTON" }, { name: "description", content: "Access your HASTON account." }] }),
  component: Login,
});
    ...
    <div className="grid min-h-[85vh] grid-cols-1 md:grid-cols-2">
      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col justify-between p-12 text-primary-foreground">
          <Link to="/" className="text-display text-2xl tracking-[0.3em]">HASTON</Link>
          <div>
      ...
      <div className="grid place-items-center px-6 py-16 md:px-16">
        ...
        >
          ...
          <p className="mt-4 text-sm text-muted-foreground">Access orders, saved pieces and private previews.</p>
          ...
          <div className="mt-10 space-y-5">
            ...
            <div className="flex items-center justify-between text-[11px] uppercase tracking-[0.28em]">
              ...
              <Link to="/login" className="underline">Forgot?</Link>
            </div>
          </div>

          <LuxeButton className="mt-8 w-full" arrow>Sign in</LuxeButton>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <button className="rounded-full border border-border py-3 text-[11px] uppercase tracking-[0.24em] transition-colors hover:bg-muted">Continue with Google</button>
            <button className="rounded-full border border-border py-3 text-[11px] uppercase tracking-[0.24em] transition-colors hover:bg-muted">Continue with Apple</button>
          </div>
