...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "The story of HASTON — a Milan-founded menswear house building considered, casual pieces with unhurried craft." },
          ...
          <div>
            ...
            <Reveal delay={0.2}>
              <div className="mt-8 space-y-5 text-base leading-relaxed text-muted-foreground">
                <p>House of Valerion opened a small atelier off Via della Spiga with a single idea — that casual wear had been left behind. Jackets and suits carried craft. Shirts, sweaters and trousers, mostly, did not.</p>
                <p>HASTON is our answer. Every piece begins with a fabric visit — most often to a mill we've known for years. Then a paper block. Then twenty fittings. Then, sometimes, we still start again.</p>
                <p>Today, thirty-eight people work under our roof across Milan, London and Mumbai. Small enough to know our tailors by name. Large enough to make things properly.</p>
              </div>
            </Reveal>
          </div>
        </div>
      ...
      <section className="bg-primary py-24 text-primary-foreground md:py-32">
        <div className="mx-auto grid max-w-[1600px] grid-cols-2 gap-8 px-6 md:grid-cols-4 md:px-10">
          {[
            ...
            >
              <p className="text-display text-5xl md:text-6xl"><CountUp end={s.n} /><span className="text-accent">{s.s}</span></p>
        ...
        <div className="grid grid-cols-1 gap-16 md:grid-cols-2">
          <div>
            ...
            <p className="mt-6 text-base leading-relaxed text-muted-foreground">
              We source in small volumes from single mills — Fox Brothers in Somerset, Loro Piana in Piedmont, Bonotto near Venice. If we can't trace a fibre to its origin, we don't buy it.
            </p>
          </div>
          <div>
            ...
            <p className="mt-6 text-base leading-relaxed text-muted-foreground">
              Every piece is finished by hand — buttonholes on the shirts, buttons on the jackets, hems on the trousers. It costs us more. It costs the piece less.
            </p>
          </div>
        </div>
        <div className="mt-16 flex justify-center">
          <LuxeButton to="/journal" variant="outline" arrow>Read the journal</LuxeButton>
        </div>
      </section>
    </>
  );
