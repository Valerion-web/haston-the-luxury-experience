...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — HASTON" },
      { name: "description", content: "Reach the HASTON client service team." },
    ],
  }),
  component: Contact,
});
...
const channels = [
  ...
  { icon: Phone, title: "Phone", body: "+39 02 7600 1234", note: "Mon–Sat, 10–19 CET" },
  {
    icon: MessageSquare,
    title: "Concierge",
    body: "Chat with a stylist",
    note: "Live in every store",
  },
  {
    icon: MapPin,
    title: "Head office",
    body: "Via della Spiga 27, Milano",
    note: "By appointment",
  },
];
          ...
          <form className="rounded-md border border-border bg-card p-8 soft-shadow">
            ...
            <div className="mt-6 space-y-5">
              ...
              <label className="block">
                ...
                <textarea
                  rows={5}
                  className="mt-2 block w-full resize-none rounded-md border border-border bg-transparent px-4 py-3 text-sm transition-colors focus:border-primary focus:outline-none"
                />
              </label>
            </div>
            <LuxeButton className="mt-8" arrow>
              Send message
            </LuxeButton>
          </form>
        </div>
